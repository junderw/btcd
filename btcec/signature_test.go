...
func TestRFC6979(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			"a4fa487a866fa850f6257c0d052ab9531025f014df8d42fa36acda96fe5217eb",
		...
		},
		{
			...
			"7c9eed6aa32fbfe4d722c7b8ff4235456a0f8806128d023b77dc8101e46fa694",
		...
		},
		{
			...
			"40b6d11fa2176ba81a655f838eddd164a41fafbd211a82e8a8934a12ac78eb68",
		...
		},
		{
			...
			"c6e0b4de4b4aad2c99e60b12ba8edb8f75e5e28a485c42dc9805ed6a3958f52b",
		...
		},
		{
			...
			"55e42acc05e2c7d1778ef25d22f65004e063146f9105371a54513d2f312441f1",
		...
		},
		{
			...
			"6ddbe8925384eef99d125631b93c93ea0a9db73685ea14c21fa0f63ee2e8021e",
	...
	for i, test := range tests {
		...
		// Also ensure that the "bad R or S" loop will return the correct nonces.
		gotNonce := nonceRFC6979(privKey.D, hash[:], 0).Bytes()
		fiveSkipNonce := nonceRFC6979(privKey.D, hash[:], 5).Bytes()
		wantNonce := decodeHex(test.nonce)
		wantfiveSkipNonce := decodeHex(test.nonceSkip5)
		...
		if !bytes.Equal(fiveSkipNonce, wantfiveSkipNonce) {
			t.Errorf("NonceRFC6979 #%d (%s): Nonce (skip 5) is incorrect: "+
				"%x (expected %x)", i, test.msg, fiveSkipNonce,
				wantfiveSkipNonce)
			continue
		}
